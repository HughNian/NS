...
class CommonAction extends AbstractAction
{
    ...
    {
    	//加载项目常量
    	require_array(array(APP_PATH . DIRECTORY_SEPARATOR . 'Common' . DIRECTORY_SEPARATOR . 'Const.php'), true);
    }
     ...
     */
    public function _setViewName($viewName)
    {
    	$this->_view = new SmartyDriver($viewName);
    }
